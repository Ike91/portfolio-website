...
function Projects() {
  ...
  return (
    <div className="project p-3 sm:ml-64 sm:mr-40">
                ...
                <div className="row mb-4">
                  <div className="col-md-6 item">
                    <div className="item-in text-gray-500">
                      ...
                      <div className="seperator"></div>
                      <p>
                        This project aimed to meticulously analyze sales data
                        from three branches across highly populated cities,
                        spanning three months, to derive actionable insights.
                        These insights would enhance business performance.
                      </p>
